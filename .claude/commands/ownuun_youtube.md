...
분석 완료 후 결과를 crawled_content 테이블에 저장합니다.

**저장 데이터:**
- `digest_result`: 5단계에서 생성한 JSON 객체
...
VIDEO_ID와 JSON_RESULT를 실제 값으로 대체하여 실행합니다.
